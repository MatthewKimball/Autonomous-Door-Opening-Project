...
class JacoArm
{
 public:
    ...
    void calibrationCallback(const geometry_msgs::Vector3ConstPtr& calibrate);

    void elevatorButtonCallback(const geometry_msgs::TwistStampedConstPtr& cartesian_vel);

    void dooropenCallback(const jaco_msgs::DoorOpenConstPtr& door_characteristics);
 ...
 private:
    ...
    void elevatorButtonTimer(const ros::TimerEvent&);
    void dooropenTimer(const ros::TimerEvent&);
    ...
    JacoComm &jaco_comm_;
    jaco::MicoManip manipulate;

    // Publishers, subscribers, services
    ros::Subscriber joint_velocity_subscriber_;
    ros::Subscriber cartesian_velocity_subscriber_;
    ros::Subscriber elevator_button_subscriber_;
    ros::Subscriber door_open_subscriber_;
    ros::Subscriber calibration_subscriber_;
    ...
    CartesianInfo cartesian_position_;
    DoorInfo door;
